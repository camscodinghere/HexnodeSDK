...
type Params = {
    ...
    app_management?: {
        whitelist_apps?: {app?:number[], group?:number[]},
        blacklist_apps?: {app?:number[], group?:number[]},
        mandatory_apps?: {app?:number[], group?:number[]},
        catalogs?: any
    },
    general_settings?: {
        location_settings?: {
...
export default async function (inParams: Params) {
    ...
    return await apiRequest({apiKey, portal, endpoint: `policy/${policyId}/`, params, method:'put'});
}